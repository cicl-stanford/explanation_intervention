...
for (var i = 0; i < cn_len_short; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_short/round_one_' + i + '.png"></img>' +
        '<p>' + cn_arr_short[i] + '</p></div>';
...
for (var i = 0; i < cn_len_short; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_short/round_two_' + i + '.png"></img>' +
        '<p>' + cn_arr_short[i] + '</p></div>';
...
const cn_selection_task_short = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cn_image' src='media/cn_short/explanation_selection.png'></img>",
    questions: [
        {
...
const cn_intervention_task_short = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cp_image' src='media/cn_short/intervention_task.png'></img>",
    questions: [
        {
