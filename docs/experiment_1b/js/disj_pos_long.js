...
for (var i = 0; i < dp_len_long; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_long/round_one_' + i + '.png"></img>' +
        '<p>' + dp_arr_long[i] + '</p></div>';
...
for (var i = 0; i < dp_len_long; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_long/round_two_' + i + '.png"></img>' +
        '<p>' + dp_arr_long[i] + '</p></div>';
...
const dp_selection_task_long = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='dp_image' src='media/dp_long/explanation_selection.png'></img>",
    questions: [
        {
...
const dp_intervention_task_long = {
    ...
    preamble: `<div style="text-align:center; max-width:900px;">` +
        ...
        "<img class='dp_image' src='media/dp_long/intervention_task.png'></img>",
    questions: [
        {
