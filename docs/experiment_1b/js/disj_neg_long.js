...
for (var i = 0; i < dn_len_long; i++) {
    let slide = '<div><img class="dn_image" src="media/dn_long/round_one_' + i + '.png"></img>' +
        '<p>' + dn_arr_long[i] + '</p></div>';
...
for (var i = 0; i < dn_len_long; i++) {
    let slide = '<div><img class="dn_image" src="media/dn_long/round_two_' + i + '.png"></img>' +
        '<p>' + dn_arr_long[i] + '</p></div>';
...
const dn_selection_task_long = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='dn_image' src='media/dn_long/explanation_selection.png'></img>",
    questions: [
        {
...
const dn_intervention_task_long = {
    ...
    preamble: `<div style="text-align:center; max-width:900px;">` +
        ...
        "<img class='dp_image' src='media/dn_long/intervention_task.png'></img>",
    questions: [
        {
