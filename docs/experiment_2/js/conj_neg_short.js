...
for (var i = 0; i < cn_len_short; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_short/setup_' + i + '.jpg"></img>' +
...
for (var i = 0; i < cn_len_short; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_short/round_one_' + i + '.jpg"></img>' +
        '<p>' + cn_arr_short[i] + '</p></div>';
...
for (var i = 0; i < cn_len_short; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_short/round_two_' + i + '.jpg"></img>' +
        '<p>' + cn_arr_short[i] + '</p></div>';
