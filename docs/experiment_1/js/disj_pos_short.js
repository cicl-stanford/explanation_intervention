...
for (var i = 0; i < dp_len_short; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_short/setup_' + i + '.jpeg"></img>' +
...
for (var i = 0; i < dp_len_short; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_short/round_one_' + i + '.jpeg"></img>' +
        '<p>' + dp_arr_short[i] + '</p></div>';
...
for (var i = 0; i < dp_len_short; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_short/round_two_' + i + '.jpeg"></img>' +
        '<p>' + dp_arr_short[i] + '</p></div>';
...
const dp_selection_task_short = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='dp_image' src='media/dp_short/explanation_selection.jpeg'></img>",
    questions: [
        {
...
const dp_intervention_task_short = {
    ...
    preamble: `<div style="text-align:center; max-width:900px;">` +
        ...
        "<img class='dp_image' src='media/dp_short/intervention_task.jpeg'></img>",
    questions: [
        {
