const consent = {
    ...
    <div style="text-align:left;
       ...
       <b>Description:</b>
            ...
            You may be asked a number of different questions about making judgments and interpreting
            people's actions. All information collected will remain confidential.
       </p>
       <p> 
       <b>Risks and benefits:</b> 
            Risks involved in this study are the same as those normally associated 
            with using a computer (e.g., mild eye/arm strain). If you have any
            pre-existing conditions that might make reading and completing a computer-based
            survey strenuous for you, you should probably elect to not participate in this
            study. If at any time during the study you feel unable to participate because
            you are experiencing strain, you may end your participation without penalty.
            We cannot and do not guarantee or promise that you will receive any benefits
            from this study. Your decision whether or not to participate in this study will
            not affect your employment, medical care, and/or grades in school.
       </p>
       <p>
       <b>Time involvement:</b>
            Your involvement in this study should take about 10-15 minutes. 
       </p>
       <p>
       <b>Payment:</b>
            If recruitment materials indicate payment (e.g., Prolific or other recruitment), you
            will receive compensation as indicated.
       </p>
       <b>Subject's rights:</b>
            ...
            to which you are otherwise entitled.  The alternative is not to participate.
            You have the right to refuse to answer particular questions.  Your individual privacy will
            be maintained in all published and written data resulting from the study.  No personally
            identifying information is ever revealed to the researchers.
       </p>
       <p>
       ...
       <p>
            You may want to print a copy of this consent form to keep. By clicking the button below,
            you acknowledge that you have read the above information, that you are 18 years of age,
            or older and give your consent to participate in our internet-based study and consent for
            us to analyze the resulting data.
        </p>
    </div>
    <p> 
