...
for (var i = 0; i < cn_len_long; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_long/round_one_' + i + '.png"></img>' +
        '<p>' + cn_arr_long[i] + '</p></div>';
...
for (var i = 0; i < cn_len_long; i++) {
    let slide = '<div><img class="cn_image" src="media/cn_long/round_two_' + i + '.png"></img>' +
        '<p>' + cn_arr_long[i] + '</p></div>';
...
const cn_selection_task_long = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cn_image' src='media/cn_long/explanation_selection.png'></img>",
    questions: [
        {
...
const cn_intervention_task_long = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cp_image' src='media/cn_long/intervention_task.png'></img>",
    questions: [
        {
