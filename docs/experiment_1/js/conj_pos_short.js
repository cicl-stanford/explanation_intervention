...
for (var i = 0; i < cp_len_short; i++) {
    let slide = '<div><img class="cp_image" src="media/cp_short/setup_' + i + '.jpeg"></img>' +
...
for (var i = 0; i < cp_len_short; i++) {
    let slide = '<div><img class="cp_image" src="media/cp_short/round_one_' + i + '.jpeg"></img>' +
        '<p>' + cp_arr_short[i] + '</p></div>';
...
for (var i = 0; i < cp_len_short; i++) {
    let slide = '<div><img class="cp_image" src="media/cp_short/round_two_' + i + '.jpeg"></img>' +
        '<p>' + cp_arr_short[i] + '</p></div>';
...
const cp_selection_task_short = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cp_image' src='media/cp_short/explanation_selection.jpeg'></img>",
    questions: [
        {
...
const cp_intervention_task_short = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cp_image' src='media/cp_short/intervention_task.jpeg'></img>",
    questions: [
        {
