...
for (var i = 0; i < cp_len_long; i++) {
    let slide = '<div><img class="cp_image" src="media/cp_long/round_one_' + i + '.png"></img>' +
        '<p>' + cp_arr_long[i] + '</p></div>';
...
for (var i = 0; i < cp_len_long; i++) {
    let slide = '<div><img class="cp_image" src="media/cp_long/round_two_' + i + '.png"></img>' +
        '<p>' + cp_arr_long[i] + '</p></div>';
...
const cp_selection_task_long = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cp_image' src='media/cp_long/explanation_selection.png'></img>",
    questions: [
        {
...
const cp_intervention_task_long = {
    ...
    preamble: `<div style="text-align:center; padding:20px; max-width:900px;">` +
        ...
        "<img class='cp_image' src='media/cp_long/intervention_task.png'></img>",
    questions: [
        {
