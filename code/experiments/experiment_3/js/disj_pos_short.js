...
for (var i = 0; i < dp_len_short; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_short/setup_' + i + '.jpg"></img>' +
...
for (var i = 0; i < dp_len_short; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_short/round_one_' + i + '.jpg"></img>' +
        '<p>' + dp_arr_short[i] + '</p></div>';
...
for (var i = 0; i < dp_len_short; i++) {
    let slide = '<div><img class="dp_image" src="media/dp_short/round_two_' + i + '.jpg"></img>' +
        '<p>' + dp_arr_short[i] + '</p></div>';
