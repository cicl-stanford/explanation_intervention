---
  title: "Explanation Valence: Probablity Estimates"
author: "Lara Kirfel"
...
df.data8 <- merge(df.responses, df.participants, by="workerid") 
```
...
write_csv(df.exp8_summary, "fixedint_pos.csv")
...
```{r}
  ...
  FigExplanations<- ggplot(df.exp8, aes(x=explanation, group = CausalStructure))+
