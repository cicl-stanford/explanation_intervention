---
  title: "Explanation Valence Full Study: Negative Outcome"
author: "Lara Kirfel"
...
write_csv(df.exp3_summary, "hardint_neg.csv")
...
```{r}
  ...
  FigExplanations<- ggplot(df.exp3, aes(x=explanation, group = CausalStructure))+
