...
df.responses = read.csv(file = "costintervention_withint-responses.csv", stringsAsFactors = F, sep = ",") %>% 
      select(-error)


df.participants <- read.csv(file = "costintervention_withint-participants.csv", stringsAsFactors = F, sep = ",") %>% 
