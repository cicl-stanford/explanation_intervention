---
  title: "Explanation Valence: Fixed Interventions: Outcome"
author: "Lara Kirfel"
...
df.data9 <- merge(df.responses, df.participants, by="workerid") 
```
...
write_csv(df.exp9_summary, "fixedint_neg.csv")
...
#Show plot
plot(FigExp)
ggsave(FigExp, file="FigExp.png", dpi=400, height = 4, width = 7)
...
```{r}
  ...
  FigExplanations<- ggplot(df.exp9, aes(x=explanation, group = CausalStructure))+
